...
//adds row and sets innerHTML by taking array of nutrition facts
...
//function get user food history data from database and show to user in html table
async function getData() {
  //gets user input
  let param = {
    Meal: document.getElementsByName("Meal")[0].value.toString(),
    Date: document.getElementsByName("day")[0].value.toString(),
  };
